...
<head>
    <meta charset="UTF-8">
    <title>Anniversaries/Jubilees</title>
...
<body>
    ...
    <section class="breadcrumb-area style2" style="background-image: url(images/resources/breadcrumb-bg-4.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="inner-content-box clearfix">
                        <div class="title-s2 text-center ">
                            ...
                            <h1>Anniversaries & Jubilees</h1>
                        </div>
                        <div class="breadcrumb-menu float-left">
                            <ul class="clearfix">
                                <li><a href="index-3.php">Home</a></li>
                                <li><a href="index-3.php">Events</a></li>
                                <li class="active">Anniversaries&Jubilees</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="sec-title with-text max-width text-center wow fadeInDown animated" data-wow-delay="100ms"
            ...
            <div class="title m-5">For your cherished loved one/valued enterprise</div>
            <p class="bottom-text">At Plantastic Events, we bring your anniversaries and corporate jubilees to life with
                exceptional designs and elegant themes, creating unforgettable experiences and lasting impressions.</p>
        </div>
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="single-service-style1 wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1200ms"
                    ...
                    <div class="img-holder">
                        <img src="images/services/a1.jpg" alt="Awesome Image">
                        ...
                        <div class="overlay-content-box">
                            <div class="box">
                                <div class="inner">
                                    ...
                                    <div class="title">
                                        <h3><a href="booking.php">Wedding Anniversary</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-holder">
                        <div class="inner-content">
                            ...
                            <div class="bottom">
                                ...
                                <div class="read-more">
                                    <a href="booking.php"><span class="icon-next"></span></a>
                                </div>
                            </div>
                        </div>
                        <div class="overlay-content">
                            <div class="text">
                                <p>We design everything from romantic themes to delightful surprises, creating the
                                    perfect ambiance to celebrate your cherished moments together</p>
                            </div>
                            <div class="read-more">
                                <a href="booking.php"><span class="icon-next"></span></a>
                            </div>
            ...
            <!--Start single service style1-->
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="single-service-style1 wow fadeInUp animated" data-wow-delay="200ms"
                    data-wow-duration="1200ms"
                    style="visibility: visible; animation-duration: 1200ms; animation-delay: 200ms; animation-name: fadeInUp;">
                    <div class="img-holder">
                        <img src="images/services/a2.jpg" alt="Awesome Image">
                        <div class="overlay-style-two"></div>
                        <div class="overlay-content-box">
                            <div class="box">
                                <div class="inner">
                                    ...
                                    <div class="title">
                                        <h3><a href="booking.php">Corporate Jubilees</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-holder">
                        ...
                        <div class="overlay-content">
                            <div class="text">
                                <p>Let Plantastic Events craft the perfect corporate jubilee celebration, reflecting
                                    success, elegance, and unforgettable moments for your organization.</p>
                            </div>
                            <div class="read-more">
                                <a href="booking.php"><span class="icon-next"></span></a>
                            </div>
