...
<body>
    ...
    <section class="breadcrumb-area style2" style="background-image: url(images/resources/breadcrumb-bg-6.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="inner-content-box clearfix">
                        <div class="title-s2 text-center ">
                            ...
                            <h1>Couples Exclusive</h1>
                        </div>
                        <div class="breadcrumb-menu float-left">
                            <ul class="clearfix">
                                <li><a href="index-3.php">Home</a></li>
                                <li><a href="index-3.php">Events</a></li>
                                <li class="active">Couples Exclusive</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="sec-title with-text max-width text-center wow fadeInDown animated" data-wow-delay="100ms"
            ...
            <div class="title m-5">For your loved one</div>
            <p class="bottom-text">At Plantastic Events, we turn your wedding proposals and Valentine celebrations into
                magical moments with exceptional designs and romantic themes, creating unforgettable experiences and
                lasting memories.</p>
        </div>
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="single-service-style1 wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1200ms"
                    ...
                    <div class="img-holder">
                        <img src="images/services/ce1.jpg" alt="Awesome Image">
                        ...
                        <div class="overlay-content-box">
                            <div class="box">
                                <div class="inner">
                                    ...
                                    <div class="title">
                                        <h3><a href="booking.php">Proposal</a> </h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-holder">
                        ...
                        <div class="overlay-content">
                            <div class="text">
                                <p>We design romantic setups that perfectly express your love and create a magical
                                    moment to cherish forever.</p>
                            </div>
                            <div class="read-more">
                                <a href="booking.php"><span class="icon-next"></span></a>
                            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="single-service-style1 wow fadeInUp animated" data-wow-delay="200ms"
                    ...
                    <div class="img-holder">
                        <img src="images/services/ce2.jpg" alt="Awesome Image">
                        <div class="overlay-style-two"></div>
                        <div class="overlay-content-box">
                            <div class="box">
                                <div class="inner">
                                    ...
                                    <div class="title">
                                        <h3><a href="booking.php">Valentine</a> </h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-holder">
                        ...
                        <div class="overlay-content">
                            <div class="text">
                                <p>Celebrate love this Valentine’s Day with enchanting themes and intimate setups by
                                    Plantastic Events.</p>
                            </div>
                            <div class="read-more">
                                <a href="booking.php"><span class="icon-next"></span></a>
